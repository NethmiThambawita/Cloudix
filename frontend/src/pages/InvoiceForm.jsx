      ...
      <Card style={{ marginTop: 20 }}>
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
            ...
            <Form.Item name="dueDate" label="Due Date" initialValue={dayjs().add(30, 'days')}>
              <DatePicker style={{ width: '100%' }} format="YYYY-MM-DD" />
            </Form.Item>
          </div>
          ...
          <Form.Item 
            ...
            label={
              <span>
                Notes{' '}
                <Tooltip title="Loaded from Settings → Templates. You can edit for this specific invoice.">
                  <InfoCircleOutlined style={{ color: '#1890ff' }} />
                </Tooltip>
              </span>
            }
          >
            <Input.TextArea rows={3} placeholder="These notes will appear on the invoice..." />
          </Form.Item>
          ...
          >
            <Input.TextArea rows={5} placeholder="Terms and conditions for this invoice..." />
          </Form.Item>
